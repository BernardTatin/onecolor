//
// Created by bernard on 28/04/22.
//
 ...
 * ===============================================================*/
static void
basic_demo(struct nk_context *ctx, struct nk_image image) {
    if (nk_begin(ctx, "Demo", nk_rect(420, 10, WINDOW_HEIGHT - 5, 590),
...
int main(void) {
    struct nk_image image = image_create();
